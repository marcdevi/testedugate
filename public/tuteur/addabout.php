...
require '../../app/controllers/controllersprofil/AddAboutController.php';
if (!isConnected()) {
...
<body>
    ...
    <main class="" style="margin-top: 10%;padding: 0 10%;">
        ...
        <div class="mb-5">
            ...
            <form method="post">
                <textarea class="form-control w-100" aria-label="Username" placeholder="A propos de vous" aria-describedby="basic-addon1" name="about"></textarea>
