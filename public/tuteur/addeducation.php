...
require '../../app/controllers/controllersprofil/AddEducationController.php';
if (!isConnected()) {
        ...
        <div class="mb-5">
            ...
            <form method="post">
                <div class="input-group mb-3 d-flex flex-column">
                    ...
                    <input type="mail" class="form-control w-100" aria-label="Username" placeholder="etablissement" aria-describedby="basic-addon1" name="nom_etablissement">
                </div>
                <div class="input-group mb-3 d-flex flex-column">
                    <h4>Nom du diplome *</h4>
                    <input type="mail" class="form-control w-100" aria-label="Username" placeholder="diplome" aria-describedby="basic-addon1" name="nom_diplome">
                </div>
                <div class="input-group mb-3 d-flex flex-column">
                    <h4>l'année *</h4>
