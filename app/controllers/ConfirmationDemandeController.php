...
try {
    ...
    $mail->Subject = 'Confirmation de demande';
    $mail->Body    = '<p>Nous avons recu votre demande,</p><br><p>Nous allons vous revenir dans les plus bref délais<br></p><br><br><p>Bien cordialement.</p>';
