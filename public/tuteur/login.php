...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="profil.php">Tuteur</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="../parent/demande.php">Parent</a>
                </li>
            </ul>
            </div>
        </div>
    ...
    <?php require '../../app/controllers/LoginCompteController.php' ?>
