...
require '../../app/controllers/controllersprofil/UpdateSkillsController.php';
if (!isConnected()) {
        ...
        <div class="mb-5">
            <form method="post">
                <div class="input-group mb-3 d-flex flex-column">
                    <h4>Skill *</h4>
                    <input type="text" class="form-control w-100" aria-label="Username" placeholder="Votre compétence" aria-describedby="basic-addon1" name="skill" value="<?= $compte_skills[0]['skill'] ?>">
                </div>
                <div class="d-flex justify-content-end mt-5">
                    <button type="submit" class="btn btn-primary w-25">Ajouter</button>
                </div>
            </form>
            <a href="deleteskills.php?skills=<?= $compte_skills[0]['id'] ?>&compte=<?= $id ?>"><button class="btn btn-danger">Supprimer</button></a>
        </div>
    </main>
    <footer>
